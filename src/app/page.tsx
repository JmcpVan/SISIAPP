...
export default function Home() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-gray-50 dark:bg-gray-900/50">
      ...
      <section id="acerca-de" className="w-full md:pb-24 pt-16">
          <div className="grid md:grid-cols-2 gap-12">
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 flex flex-col animate-slide-in-left pt-16">
              <div>
            ...
            <div className="relative animate-slide-in-right overflow-hidden h-[500px] md:h-[700px] flex items-start justify-center p-12">
