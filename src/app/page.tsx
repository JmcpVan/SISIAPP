      ...
      <section className="relative w-full h-[400px] md:h-[500px] flex items-center justify-center text-center text-white">
        ...
        <div className="relative z-10 p-4 space-y-6">
          <h1 className="text-4xl md:text-6xl font-bold font-headline drop-shadow-lg">
            Discover & Offer Local Services
          </h1>
          <p className="text-lg md:text-xl max-w-3xl mx-auto drop-shadow-md">
            SISIAPP connects you with trusted local service providers, validated by our team for quality and reliability.
          </p>
          <Button asChild size="lg">
            <Link href="/register">Register Your Service</Link>
          </Button>
        </div>
      </section>
      ...
      <section id="services" className="py-12 md:py-20 bg-secondary/50">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground mt-2 text-lg">Browse services offered in your community.</p>
          </div>
