  ...
  return (
    <div className="flex flex-col min-h-screen bg-gray-50 dark:bg-gray-900/50">
      ...
      <main className="flex-1">
        <section className="relative w-full grid md:grid-cols-2 gap-8 md:min-h-[50vh] overflow-hidden pt-12 md:pt-24">
        ...
        <section id="servicios" className="container mx-auto px-4 sm:px-6 lg:px-8 py-16 scroll-mt-28 mt-12">
